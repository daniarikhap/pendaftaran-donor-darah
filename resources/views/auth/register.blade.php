<x-guest-layout>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-5">
        ...
        <div class="space-y-1.5">
            <label for="pegawai_nama" class="block font-semibold text-sm text-slate-700">{{ __('Nama Lengkap Pegawai') }}</label>
            <div class="relative">
        ...
        <!-- Nomor Identitas -->
        <div class="space-y-1.5">
            <label for="nomoridentitas" class="block font-semibold text-sm text-slate-700">{{ __('Nomor Identitas (NIK)') }}</label>
            <div class="relative">
                <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-slate-400">
        ...
        <div class="space-y-1.5">
            <label for="nomorindukpegawai" class="block font-semibold text-sm text-slate-700">{{ __('Nomor Induk Pegawai (NIP)') }}</label>
            <div class="relative">
                <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-slate-400">
                    <!-- ID badge icon -->
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <!-- Username -->
        <div class="space-y-1.5">
            <label for="username" class="block font-semibold text-sm text-slate-700">{{ __('Username') }}</label>
            <div class="relative">
                <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-slate-400">
                    <!-- At icon -->
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <!-- Confirm Password -->
        <div class="space-y-1.5">
            <label for="password_confirmation" class="block font-semibold text-sm text-slate-700">{{ __('Konfirmasi Kata Sandi') }}</label>
            <div class="relative">
                <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-slate-400">
